...
#[Fillable(['name', 'email', 'google_id', 'avatar_url', 'password', 'status', 'preferences', 'login_enabled', 'source', 'external_reference'])]
#[Hidden(['password'])]
class User extends Authenticatable
{
    ...
    {
        return $this->hasAnyRole([UserRole::CEO, UserRole::Manager, UserRole::Admin]);
    }
}