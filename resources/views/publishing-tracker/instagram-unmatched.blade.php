@extends('layouts.app')
@section('title', 'Unmatched Instagram Media')
@section('content')
    <div class="p-4 sm:p-6 lg:p-8 max-w-[1400px] mx-auto">
        <div class="flex items-center gap-3 mb-2">
            ...
            <div>
                <h1 class="font-display text-[26px] font-semibold text-[var(--text-primary)]">Unmatched Instagram Media</h1>
        ...
        <p class="text-sm text-[var(--text-muted)] mb-1">
            {{ $totalSnapshotted }} media tersimpan dari sync sebelumnya, {{ count($unmatched) }} belum terhubung ke content item.
        </p>
        <p class="text-xs text-[var(--text-muted)] mb-6">
            ...
            Halaman ini tidak menarik data baru dari Instagram - jalankan Sync di halaman Client Detail untuk data terkini.
        </p>
        ...
        <div class="card overflow-hidden">
            @if (empty($unmatched))
                <div class="px-6 py-12 text-center">
                    ...
                    <p class="text-sm text-[var(--text-muted)]">Semua media Instagram akun ini sudah terhubung ke content item.</p>
                </div>
            @else
