...
<body class="min-h-screen" x-data="{ showRevisionForm: false }">
    ...
    <div class="p-5 space-y-4">
        ...
        @if (session('status'))
            <div class="bg-[#f0f5f4] border border-[#dbe6e4] text-[#044b46] text-sm p-3 rounded-xl font-medium">{{ session('status') }}</div>
        @endif
        @if ($errors->any())
            <div class="bg-[#fdf2f1] border border-[#f5d9d7] text-[#b3423e] text-sm p-3 rounded-xl font-medium">{{ $errors->first() }}</div>
        @endif
