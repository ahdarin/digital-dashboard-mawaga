                ...
                <div class="flex items-end justify-between gap-4 h-56">
                    @foreach ($performance as $i => $bar)
                        <div class="flex-1 flex flex-col items-center gap-3">
                            ...
                            <div
                                class="w-full max-w-14 rounded-t-lg transition-all duration-300 {{ $i === $peak && $bar['value'] > 0 ? 'bg-[#044b46]' : 'bg-[#044b46]/25' }}"
...
<div class="w-[340px] shrink-0 flex flex-col gap-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm p-6 flex flex-col">
        ...
        <a href="{{ Route::has('production-workflow.index') ? route('production-workflow.index') : '#' }}"
           class="mt-4 w-full bg-[#f8faf8] text-[#044b46] text-sm font-semibold py-3 rounded-xl hover:bg-[#044b46]/10 transition-colors duration-150 flex items-center justify-center gap-1">
