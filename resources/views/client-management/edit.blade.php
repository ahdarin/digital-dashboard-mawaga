    ...
    <form action="{{ route('client-management.update', $client) }}" method="POST" enctype="multipart/form-data" class="space-y-5">
        ...
        <div class="card p-6">
            ...
            <div class="space-y-4">
                <div x-data="{ preview: null, remove: false }">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            @endif
                            <p class="text-[11px] text-[#767c80] mt-1.5">PNG/JPG, maks 2MB.</p>
                        </div>
                    </div>
                ...
                <div>
                    <label for="name" class="block text-xs font-medium text-[#767c80] uppercase mb-1.5">Nama Perusahaan</label>
                ...
                <div>
                    <label for="brand_name" class="block text-xs font-medium text-[#767c80] uppercase mb-1.5">Nama Brand</label>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <label for="client_category_id" class="block text-xs font-medium text-[#767c80] uppercase mb-1.5">Kategori</label>
                    ...
                    <div>
                        <label for="status" class="block text-xs font-medium text-[#767c80] uppercase mb-1.5">Status</label>
                ...
                <div>
                    ...
                    <input id="asset_link" type="url" name="asset_link" value="{{ old('asset_link', $client->asset_link) }}" placeholder="https://drive.google.com/..."
                           class="input placeholder:text-[#c3c7cb] {{ $errors->has('asset_link') ? 'input-error' : '' }}">
        ...
        <div class="card p-6">
            ...
            <div class="space-y-4">
                <div>
                    <label for="owner_name" class="block text-xs font-medium text-[#767c80] uppercase mb-1.5">Nama Owner {{ $client->owner ? '' : '*' }}</label>
                ...
                <div>
                    <label for="owner_email" class="block text-xs font-medium text-[#767c80] uppercase mb-1.5">Email Owner {{ $client->owner ? '' : '*' }}</label>
                ...
                <div>
                    <label for="owner_phone" class="block text-xs font-medium text-[#767c80] uppercase mb-1.5">Nomor WhatsApp {{ $client->owner ? '' : '*' }}</label>
