...
return new class extends Migration {
    public function up(): void {
        Schema::create('ai_strategy_insights', function (Blueprint $table) {
            ...
            // Data mentah performa (JSON dari buildPerformanceSummary) - disimpen
            // biar pas user diskusi/nanya lebih lanjut, AI masih bisa ngerujuk ke
            // angka aslinya, bukan cuma hasil ringkasan yang udah "dikompres".
